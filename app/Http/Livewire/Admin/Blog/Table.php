...
final class Table extends PowerGridComponent
{
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ...
            ->addColumn('category_id', function(Blog $model) {
    ...
    public function actions(): array
    {
        return [
            Button::make('edit', '<i class="fas fa-edit"></i>')
                ...
                ->target('_self')
                ->tooltip(__('Edit'))
                ->route('admin.blogs.edit', ['blog' => 'id', '_return' => $this->returnUrl()]),
            ...
            Button::make('delete', '<i class="fas fa-trash"></i>')
                ...
                ->method('delete')
                ->tooltip(__('Delete'))
                ->route('admin.blogs.destroy', ['blog' => 'id', '_return' => $this->returnUrl()]),
        ];
    }
    ...
    */
    ...
    {
        return route('admin.blogs.index', ['page' => $this->page, 'category_id' => $this->category->id ?? null]);
    }
}
