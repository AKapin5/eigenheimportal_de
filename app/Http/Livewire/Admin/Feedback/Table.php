...
final class Table extends PowerGridComponent
{
    ...
    */
    ...
    {
        return Feedback::query()->orderBy('id', 'desc');
    }
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('created_at_formatted', function (Feedback $model) {
                return Carbon::parse($model->created_at)->format('d.m.Y H:i');
            })
            ->addColumn('updated_at_formatted', function (Feedback $model) {
    ...
    public function actions(): array
    {
       return [
           Button::make('delete', '<i class="fas fa-trash"></i>')
               ...
               ->method('delete')
               ->tooltip(__('Delete'))
               ->route('admin.feedback.destroy', ['feedback' => 'id', '_return' => $this->returnUrl()]),
       ];
    }
    ...
    */
    ...
    {
        return route('admin.feedback.index', ['page' => $this->page]);
    }
}
