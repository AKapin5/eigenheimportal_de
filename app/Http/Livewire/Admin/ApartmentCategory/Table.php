...
final class Table extends PowerGridComponent
{
    ...
    */
    public function header(): array
    {
        return [
            Button::add('create')
                ->route('admin.apartment-categories.create',
    ...
    */
     ...
     *
     * @return Builder<ApartmentCategory>
     */
    ...
    */
    public function addColumns(): PowerGridEloquent
    {
        return PowerGrid::eloquent()
            ->addColumn('status', function(ApartmentCategory $model) {
                return $model->statusText;
            })
            ->addColumn('children', function(ApartmentCategory $model) {
            ...
            ->addColumn('items', function(ApartmentCategory $model) {
    ...
    public function actions(): array
    {
       return [
           Button::make('edit', '<i class="fas fa-edit"></i>')
               ...
               ->target('_self')
               ->tooltip(__('Edit'))
               ->route('admin.apartment-categories.edit', ['apartmentCategory' => 'id', '_return' => $this->returnUrl()]),
           ...
           Button::make('delete', '<i class="fas fa-trash"></i>')
               ...
               ->method('delete')
               ->tooltip(__('Delete'))
               ->route('admin.apartment-categories.destroy', ['apartmentCategory' => 'id', '_return' => $this->returnUrl()]),
       ];
    }
    ...
    */
    ...
    {
        return route('admin.apartment-categories.index', ['page' => $this->page, 'parent_id' => $this->parent->id ?? null]);
    }
}
